...
{
    /// <summary>
    /// Extending from class <see cref="PageModel"/>, the class <see cref="ResetAuthenticatorModel"/> contains actions of a page created by Identity but actually not used in the application.
    /// </summary>
